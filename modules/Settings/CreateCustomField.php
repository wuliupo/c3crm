...
$cfimagecombo = Array($image_path."text.gif",
						...
						$image_path."cfcurrency.gif",                        $image_path."date.gif",
...
$cftextcombo = Array($mod_strings['Text'],                        
                        $mod_strings['Number'],
                        $mod_strings['Percent'],
						$mod_strings['Currency'],                        $mod_strings['Date'],
                        $mod_strings['Email'],
                        $mod_strings['Phone'],
...
$output .='<div class="modal-header"><button class="close" type="button" data-dismiss="modal" aria-hidden="true">&times;</button>';
    ...
    $output .= '<h3 id="myMOdalLabel">'.$mod_strings['LBL_ADD_FIELD'].'</h3></div> ';
$output .= '<div class="modal-body"><script language="JavaScript" type="text/javascript" src="include/js/customview.js"></script>
                <form action="index.php" method="post" id="addtodb" name="addtodb" onSubmit="return validate()">
 ...
 if($mode !='edit'){
     $output .= '<div class="span3 pull-left" >'.$mod_strings['LBL_SELECT_FIELD_TYPE'].'
                    <div name="cfcombo" id="cfcombo" class="small"style="width:205px;height:150px;overflow-y:auto;overflow-x:hidden;
                        overflow:auto;border:1px solid #CCCCCC;">'.$combo_output.'
                    </div> 
                </div>';
                }
      $output .='<div class="span7 pull-right">
                    <table class=" table-condensed">
                        <tr>
                            <td align="right">
                            <label style="font-size:12px" for="fldMandatory"><strong>'.$mod_strings['LBL_MANDATORY'].'</strong></label>
                            </td>
                            <td>
                            <input id="fldMandatory" name="fldMandatory" value="1" type="checkbox" '.$customfield_fieldmandatory.'  />
                            </td>
                        </tr>
                        <tr>
							<td  nowrap="nowrap" align="right"><strong>'.$mod_strings['LBL_LABEL'].' </strong></td>
                ...
                if($mode == 'edit')
                {
					...
					$output .= '<tr id="lengthdetails">
									<td align="right"><strong>'.$mod_strings['LBL_LENGTH'].'</strong></td>
									<td align="left"><input type="text" name="fldLength" value="'.$fieldlength.'" '.$readonly.' ></td>
								</tr>';
								break;
							case 71:
							case 9:
							case 7:
								$output .= '<tr id="lengthdetails">
									<td nowrap="nowrap" align="right"><strong>'.$mod_strings['LBL_LENGTH'].'</strong></td>
									<td align="left"><input type="text" name="fldLength" value="'.$fieldlength.'" '.$readonly.' ></td>
								</tr>';
								$output .= '<tr id="decimaldetails">
									<td nowrap="nowrap" align="right"><strong>'.$mod_strings['LBL_DECIMAL_PLACES'].'</strong></td>
									<td align="left"><input type="text" name="fldDecimal" value="'.$decimalvalue.'" '.$readonly.' ></td>
								</tr>';
								break;
							case 33:
							case 15:
								$output .= '<tr id="picklist">
									<td  nowrap="nowrap" align="right" valign="top"><strong>'.$mod_strings['LBL_PICK_LIST_VALUES'].'</strong></td>
									<td align="left" valign="top"><textarea name="fldPickList" rows="10" >'.$fldVal.'</textarea></td>
								</tr>';
								break;
					...
					else
					{
						...
						<tr id="decimaldetails" style="visibility:hidden;">
							<td nowrap="nowrap" align="right"><b>'.$mod_strings['LBL_DECIMAL_PLACES'].'</b></td>
							<td align="left"><input type="text" name="fldDecimal" value="'.$decimalvalue.'" '.$readonly.'></td>
						</tr>
						<tr id="picklist" style="visibility:hidden;">
							<td nowrap="nowrap" align="right" valign="top"><strong>'.$mod_strings['LBL_PICK_LIST_VALUES'].'</strong></td>
							<td align="left" valign="top"><textarea name="fldPickList" rows="10"'.$readonly.'>'.$fldVal.'</textarea></td>
						</tr>';
					}
                    $output .='</table>
                </div>
