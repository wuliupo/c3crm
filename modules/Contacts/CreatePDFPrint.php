...
{
	$associated_products = getAssociatedProducts_NoPrice("Contacts",$focus);
...
$MODULE_LABEL = $app_strings["Contacts"];
$TBS = new clsTinyButStrong;
$TBS->NoErr = true; // no more error message displayed. 
// Load the template
if(isset($module_enable_product) && $module_enable_product) 
{
	$TBS->LoadTemplate('modules/Contacts/'.$templatefile.'.html','UTF-8');
