...
if(isset($_SESSION['import_rows_in_excel']) && $_SESSION['import_rows_in_excel'] != "")
	{
		$sheet = $_SESSION['import_rows_in_excel'];
	} 
	else 
	{
		require_once("include/excel/excel_class.php");
		$data = new Spreadsheet_Excel_Reader($file_name,false);
		$sheet = $data->sheets[0]['cells'];//sheet:[maxrow] => 0 [maxcol] => 0 [numRows] => 2 [numCols] => 49 [cells]
		$_SESSION['import_rows_in_excel'] = $sheet;
	}
