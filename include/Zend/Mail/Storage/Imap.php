 ...
 */
require_once 'include/Zend/Mail/Protocol/Imap.php';
/**
 * @see Zend_Mail_Storage_Writable_Interface
 */
require_once 'include/Zend/Mail/Storage/Writable/Interface.php';
/**
 ...
 */
require_once 'include/Zend/Mail/Storage.php';
/**
 * @category   Zend
 * @package    Zend_Mail
 * @subpackage Storage
