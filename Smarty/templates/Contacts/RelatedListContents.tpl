...
<table border=0 cellspacing=0 cellpadding=0 width=100% class="small" style="border-bottom:1px solid #999999;padding:5px;">
		...
		{/if}
			...
			{elseif $header eq 'Leads'}
				<input title="Change" accessKey="" class="crmbutton small edit" value="{$APP.LBL_SELECT_BUTTON_LABEL} {$APP.Lead}" LANGUAGE=javascript onclick='return window.open("index.php?module=Leads&return_module={$MODULE}&return_action={$return_modname}&action=Popup&popuptype=detailview&select=enable&form=EditView&form_submit=false&recordid={$ID}","memday","width=640,height=602,resizable=1,scrollbars=1");' type="button"  name="button">
			...
			{elseif $header eq 'Accounts'}
				<input title="Change" accessKey="" class="crmbutton small edit" value="{$APP.LBL_SELECT_BUTTON_LABEL} {$APP.Account}" LANGUAGE=javascript onclick='return window.open("index.php?module=Accounts&return_module={$MODULE}&return_action={$return_modname}&action=Popup&popuptype=detailview&select=enable&form=EditView&form_submit=false&recordid={$ID}","memday","width=640,height=602,resizable=1,scrollbars=1");' type="button"  name="button">
