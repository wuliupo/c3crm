      ...
      <div class="span10">
        <form action="index.php" method="post" name="DetailView" id="form">
         ...
         <div  class="pull-left" style="margin-bottom:5px;" >
              <button class="btn btn-small btn-primary" style="margin-top:2px;" onclick="location.href='index.php?module=Accounts&action=ListView&parenttab=Customer'">
          ...
          <div class="pull-right" style="margin-bottom:5px;" >
               <button class="btn btn-small btn-primary" style="margin-top:2px;" onclick="this.form.return_module.value='Accounts'; this.form.return_action.value='DetailView'; this.form.isDuplicate.value='true';this.form.module.value='Accounts'; this.form.action.value='EditView'" type="submit" name="Duplicate">
