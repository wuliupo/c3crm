	...
	<div align=center>
				...
				<br>
                	   <table border=0 cellspacing=1 cellpadding=3 width=99% align="center" class="small">
                		<tr>
                            <td align="left"><input title="{$APP.LBL_CANCEL_BUTTON_LABEL}>" accessKey="{$APP.LBL_CANCEL_BUTTON_KEY}" class="crmButton small cancel" onclick="location.href='index.php?module=Settings&action=SmsUser'" type="button" name="button" value=" 返回 "></td>					<td align="right"><input title="{$APP.LBL_CANCEL_BUTTON_LABEL}>" accessKey="{$APP.LBL_CANCEL_BUTTON_KEY}" class="crmButton small cancel" onclick="location.href='index.php?module=Settings&action=SmsUser'" type="button" name="button" value=" 返回 ">						<td  width="5%" align="right"><input type="button" value=" 刷新 " name="button" class="crmbutton small edit"onclick="window.location.reload();"/></td> 
                        </tr>
                       </table>
