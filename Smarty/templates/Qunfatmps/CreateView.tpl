          ...
          <div class="span12" style="margin-left:0px;">
             <div  class="pull-left" style="margin-bottom:5px;" >
              ...
              <div class="pull-right" style="margin-bottom:5px;" >
                  <button class="btn btn-small btn-success" style="margin-top:2px;" onclick="this.form.action.value='Save'; return {$validateFunction}()" name="savebutton">
                    <i class="icon-ok icon-white"></i> 保存 </button>
                 
             </div>
             <div class="clearfix"></div>
              <div class="accordion clearfix" style="margin-top:0px;margin-bottom:0px;">
                          ...
                          <table class="table table-bordered table-hover table-condensedforev dvtable">
                           <tbody>
                               <tr>
	                            	...
	                            	<td ><input type="text" name="qunfatmpname" id="qunfatmpname" value="{$qunfatmpname}" style="width:400px;" /></td>
	                            </tr>
	                             <tr>
