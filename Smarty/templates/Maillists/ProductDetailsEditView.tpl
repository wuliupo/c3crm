...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="0" class="crmTable" id="proTab">
   ...
   <tr id="row{$row_no}" valign="top">
	...
	<td class="crmTableRow small lineOnTop" valign="top" align="left">
        <input id="{$qty}" name="{$qty}" type="text" class="small " style="width:50px" onfocus="this.className='detailedViewTextBoxOn'" onBlur="FindDuplicate(); settotalnoofrows(); calcGrandTotal();" value="{$data.$qty}"/>
	</td>
	...
	<input id="{$listPrice}" name="{$listPrice}" value="{$data.$listPrice}" type="text" class="small " style="width:70px" onBlur="calcGrandTotal();"/>
	...
	<td valign="bottom" class="crmTableRow small lineOnTop" align="left">
		<input id="{$comment}" name="{$comment}" class=small style="width:100px" value="{$data.$comment}">
	</td>
